...
const movePig = () => {
  const message = { board: 11, 'initial_state': [{ x: 3, 'y': 3 }, { 'x': 3, 'y': 4 }, { x: 3, y: 5 }, { x: 4, y: 3 }, { 'x': 5, 'y': 3 }, { x: 5, y: 4 }, { 'x': 5, 'y': 5 }], moves: [{ player: 'P', 'action': 'move', 'x': 5, 'y': 5 }, { 'player': 'F', 'action': 'block', x: 10, 'y': 10 }, { player: 'P', action: 'move', 'x': 6, y: 5 }, { player: 'F', 'action': 'block', x: 10, y: 9 }, { player: 'P', 'action': 'move', x: 7, 'y': 5 }, { 'player': 'F', action: 'block', 'x': 10, y: 8 }, { 'player': 'P', 'action': 'move', 'x': 8, y: 5 }, { player: 'F', action: 'block', x: 10, y: 7 }, { player: 'P', action: 'move', 'x': 9, y: 5 }, { player: 'F', action: 'block', 'x': 10, 'y': 6 }, { player: 'P', action: 'finish', 'x': 10, y: 5 }], winner: 'P', 'score': { P: { 'score': 5 }, 'F': { score: 5 } } };
